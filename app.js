...
const takePhoto = () => {
  ...
  shell.exec(`libcamera-jpeg --nopreview --hdr --verbose 0 --roi 0.25,0,0.5,1 --width 1920 --height 2160 -q 80 --autofocus-range macro --rawfull --awb ${awb} --denoise cdn_hq --output capture.jpg`);
